...
class FlightSessionMapper extends ClassMapperBase<FlightSession> {
  ...
  static const Field<FlightSession, String> _f$pilotid =
      Field('pilotid', _$pilotid);
  static String _$terminalid(FlightSession v) => v.terminalid;
  static const Field<FlightSession, String> _f$terminalid =
      Field('terminalid', _$terminalid);
  static DateTime _$start(FlightSession v) => v.start;
  static const Field<FlightSession, DateTime> _f$start =
      Field('start', _$start);
  static DateTime? _$end(FlightSession v) => v.end;
  static const Field<FlightSession, DateTime> _f$end =
      Field('end', _$end, opt: true);
  static int? _$takeoffcount(FlightSession v) => v.takeoffcount;
  static const Field<FlightSession, int> _f$takeoffcount =
      Field('takeoffcount', _$takeoffcount, opt: true);
  static int? _$maxAltitude(FlightSession v) => v.maxAltitude;
  static const Field<FlightSession, int> _f$maxAltitude =
      Field('maxAltitude', _$maxAltitude, opt: true);
  static bool? _$airspaceObserver(FlightSession v) => v.airspaceObserver;
  static const Field<FlightSession, bool> _f$airspaceObserver =
      Field('airspaceObserver', _$airspaceObserver, opt: true);
  static String? _$comment(FlightSession v) => v.comment;
  static const Field<FlightSession, String> _f$comment =
      Field('comment', _$comment, opt: true);
  static String? _$pilotname(FlightSession v) => v.pilotname;
  static const Field<FlightSession, String> _f$pilotname =
      Field('pilotname', _$pilotname, opt: true);
  static String? _$airport(FlightSession v) => v.airport;
  static const Field<FlightSession, String> _f$airport =
      Field('airport', _$airport, opt: true);
  static String? _$endedby(FlightSession v) => v.endedby;
  static const Field<FlightSession, String> _f$endedby =
      Field('endedby', _$endedby, opt: true);
...
mixin FlightSessionMappable {
  String toJson() {
    return FlightSessionMapper.ensureInitialized()
        .encodeJson<FlightSession>(this as FlightSession);
  }

  Map<String, dynamic> toMap() {
    return FlightSessionMapper.ensureInitialized()
        .encodeMap<FlightSession>(this as FlightSession);
  }

  FlightSessionCopyWith<FlightSession, FlightSession, FlightSession>
      get copyWith => _FlightSessionCopyWithImpl(
          this as FlightSession, $identity, $identity);
  @override
  String toString() {
    return FlightSessionMapper.ensureInitialized()
        .stringifyValue(this as FlightSession);
  }

  @override
  bool operator ==(Object other) {
    return FlightSessionMapper.ensureInitialized()
        .equalsValue(this as FlightSession, other);
  }

  @override
  int get hashCode {
    return FlightSessionMapper.ensureInitialized()
        .hashValue(this as FlightSession);
  }
}
...
extension FlightSessionValueCopy<$R, $Out>
  ...
  FlightSessionCopyWith<$R, FlightSession, $Out> get $asFlightSession =>
      $base.as((v, t, t2) => _FlightSessionCopyWithImpl(v, t, t2));
}
...
class _FlightSessionCopyWithImpl<$R, $Out>
  ...
  FlightSessionCopyWith<$R2, FlightSession, $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
      _FlightSessionCopyWithImpl($value, $cast, t);
}
