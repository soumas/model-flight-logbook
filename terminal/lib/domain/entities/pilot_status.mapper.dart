...
class PilotStatusMapper extends ClassMapperBase<PilotStatus> {
  ...
  static const Field<PilotStatus, String> _f$pilotName = Field(
    'pilotName',
    _$pilotName,
  );
  static int? _$sessionId(PilotStatus v) => v.sessionId;
  static const Field<PilotStatus, int> _f$sessionId = Field(
    'sessionId',
    _$sessionId,
    opt: true,
  );
  static DateTime? _$sessionStarttime(PilotStatus v) => v.sessionStarttime;
  static const Field<PilotStatus, DateTime> _f$sessionStarttime = Field(
    'sessionStarttime',
    _$sessionStarttime,
    opt: true,
  );
  static List<String>? _$infoMessages(PilotStatus v) => v.infoMessages;
  static const Field<PilotStatus, List<String>> _f$infoMessages = Field(
    'infoMessages',
    _$infoMessages,
    opt: true,
  );
  static List<String>? _$warnMessages(PilotStatus v) => v.warnMessages;
  static const Field<PilotStatus, List<String>> _f$warnMessages = Field(
    'warnMessages',
    _$warnMessages,
    opt: true,
  );
  static List<String>? _$errorMessages(PilotStatus v) => v.errorMessages;
  static const Field<PilotStatus, List<String>> _f$errorMessages = Field(
    'errorMessages',
    _$errorMessages,
    opt: true,
  );
...
mixin PilotStatusMappable {
  String toJson() {
    return PilotStatusMapper.ensureInitialized().encodeJson<PilotStatus>(
      this as PilotStatus,
    );
  }

  Map<String, dynamic> toMap() {
    return PilotStatusMapper.ensureInitialized().encodeMap<PilotStatus>(
      this as PilotStatus,
    );
  }

  PilotStatusCopyWith<PilotStatus, PilotStatus, PilotStatus> get copyWith =>
      _PilotStatusCopyWithImpl<PilotStatus, PilotStatus>(
        this as PilotStatus,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return PilotStatusMapper.ensureInitialized().stringifyValue(
      this as PilotStatus,
    );
  }
  ...
  bool operator ==(Object other) {
    return PilotStatusMapper.ensureInitialized().equalsValue(
      this as PilotStatus,
      other,
    );
  }
...
extension PilotStatusValueCopy<$R, $Out>
  ...
  PilotStatusCopyWith<$R, PilotStatus, $Out> get $asPilotStatus =>
      $base.as((v, t, t2) => _PilotStatusCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _PilotStatusCopyWithImpl<$R, $Out>
  ...
  PilotStatus $make(CopyWithData data) => PilotStatus(
    ...
    sessionStarttime: data.get(#sessionStarttime, or: $value.sessionStarttime),
  ...
  PilotStatusCopyWith<$R2, PilotStatus, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _PilotStatusCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
