...
class TerminalConfigMapper extends ClassMapperBase<TerminalConfig> {
  ...
  static const Field<TerminalConfig, String> _f$terminalid = Field(
    'terminalid',
    _$terminalid,
  );
  static TerminalType _$terminaltype(TerminalConfig v) => v.terminaltype;
  static const Field<TerminalConfig, TerminalType> _f$terminaltype = Field(
    'terminaltype',
    _$terminaltype,
  );
  static String _$airportname(TerminalConfig v) => v.airportname;
  static const Field<TerminalConfig, String> _f$airportname = Field(
    'airportname',
    _$airportname,
  );
  static String _$terminalname(TerminalConfig v) => v.terminalname;
  static const Field<TerminalConfig, String> _f$terminalname = Field(
    'terminalname',
    _$terminalname,
  );
  static int _$maxAltitudeM(TerminalConfig v) => v.maxAltitudeM;
  static const Field<TerminalConfig, int> _f$maxAltitudeM = Field(
    'maxAltitudeM',
    _$maxAltitudeM,
  );
  ...
  static const Field<TerminalConfig, int> _f$maxNumFlights = Field(
    'maxNumFlights',
    _$maxNumFlights,
  );
  static bool _$showPilotIDOnDashboard(TerminalConfig v) =>
      v.showPilotIDOnDashboard;
  static const Field<TerminalConfig, bool> _f$showPilotIDOnDashboard = Field(
...
mixin TerminalConfigMappable {
  String toJson() {
    return TerminalConfigMapper.ensureInitialized().encodeJson<TerminalConfig>(
      this as TerminalConfig,
    );
  }

  Map<String, dynamic> toMap() {
    return TerminalConfigMapper.ensureInitialized().encodeMap<TerminalConfig>(
      this as TerminalConfig,
    );
  }

  TerminalConfigCopyWith<TerminalConfig, TerminalConfig, TerminalConfig>
  get copyWith => _TerminalConfigCopyWithImpl<TerminalConfig, TerminalConfig>(
    this as TerminalConfig,
    $identity,
    $identity,
  );
  @override
  String toString() {
    return TerminalConfigMapper.ensureInitialized().stringifyValue(
      this as TerminalConfig,
    );
  }
  ...
  bool operator ==(Object other) {
    return TerminalConfigMapper.ensureInitialized().equalsValue(
      this as TerminalConfig,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return TerminalConfigMapper.ensureInitialized().hashValue(
      this as TerminalConfig,
    );
  }
}
...
extension TerminalConfigValueCopy<$R, $Out>
  ...
  TerminalConfigCopyWith<$R, TerminalConfig, $Out> get $asTerminalConfig =>
      $base.as((v, t, t2) => _TerminalConfigCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _TerminalConfigCopyWithImpl<$R, $Out>
  ...
  TerminalConfigCopyWith<$R2, TerminalConfig, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _TerminalConfigCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
