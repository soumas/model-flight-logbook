...
class TerminalStatusMapper extends ClassMapperBase<TerminalStatus> {
  ...
  static const Field<TerminalStatus, DateTime> _f$statusReceiveTime = Field(
    'statusReceiveTime',
    _$statusReceiveTime,
    opt: true,
  );
  ...
  static const Field<TerminalStatus, DateTime> _f$operatinghourStart = Field(
    'operatinghourStart',
    _$operatinghourStart,
    opt: true,
  );
  static DateTime? _$operatinghourEnd(TerminalStatus v) => v.operatinghourEnd;
  static const Field<TerminalStatus, DateTime> _f$operatinghourEnd = Field(
    'operatinghourEnd',
    _$operatinghourEnd,
    opt: true,
  );
  static List<String>? _$infoMessages(TerminalStatus v) => v.infoMessages;
  static const Field<TerminalStatus, List<String>> _f$infoMessages = Field(
    'infoMessages',
    _$infoMessages,
    opt: true,
  );
  static List<String>? _$warnMessages(TerminalStatus v) => v.warnMessages;
  static const Field<TerminalStatus, List<String>> _f$warnMessages = Field(
    'warnMessages',
    _$warnMessages,
    opt: true,
  );
  static List<String>? _$errorMessages(TerminalStatus v) => v.errorMessages;
  static const Field<TerminalStatus, List<String>> _f$errorMessages = Field(
    'errorMessages',
    _$errorMessages,
    opt: true,
  );
...
mixin TerminalStatusMappable {
  String toJson() {
    return TerminalStatusMapper.ensureInitialized().encodeJson<TerminalStatus>(
      this as TerminalStatus,
    );
  }

  Map<String, dynamic> toMap() {
    return TerminalStatusMapper.ensureInitialized().encodeMap<TerminalStatus>(
      this as TerminalStatus,
    );
  }

  TerminalStatusCopyWith<TerminalStatus, TerminalStatus, TerminalStatus>
  get copyWith => _TerminalStatusCopyWithImpl<TerminalStatus, TerminalStatus>(
    this as TerminalStatus,
    $identity,
    $identity,
  );
  @override
  String toString() {
    return TerminalStatusMapper.ensureInitialized().stringifyValue(
      this as TerminalStatus,
    );
  }
  ...
  bool operator ==(Object other) {
    return TerminalStatusMapper.ensureInitialized().equalsValue(
      this as TerminalStatus,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return TerminalStatusMapper.ensureInitialized().hashValue(
      this as TerminalStatus,
    );
  }
}
...
extension TerminalStatusValueCopy<$R, $Out>
  ...
  TerminalStatusCopyWith<$R, TerminalStatus, $Out> get $asTerminalStatus =>
      $base.as((v, t, t2) => _TerminalStatusCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _TerminalStatusCopyWithImpl<$R, $Out>
  ...
  TerminalStatus $make(CopyWithData data) => TerminalStatus(
    statusReceiveTime: data.get(
      #statusReceiveTime,
      or: $value.statusReceiveTime,
    ),
  ...
  TerminalStatusCopyWith<$R2, TerminalStatus, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _TerminalStatusCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
