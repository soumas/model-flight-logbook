...
class TerminalEndpointMapper extends ClassMapperBase<TerminalEndpoint> {
  ...
  static const Field<TerminalEndpoint, String> _f$apiEndpoint =
      Field('apiEndpoint', _$apiEndpoint);
  static String _$apiKey(TerminalEndpoint v) => v.apiKey;
  static const Field<TerminalEndpoint, String> _f$apiKey =
...
mixin TerminalEndpointMappable {
  ...
  TerminalEndpointCopyWith<TerminalEndpoint, TerminalEndpoint, TerminalEndpoint>
      get copyWith => _TerminalEndpointCopyWithImpl(
          this as TerminalEndpoint, $identity, $identity);
  @override
  String toString() {
    return TerminalEndpointMapper.ensureInitialized()
        .stringifyValue(this as TerminalEndpoint);
  }

  @override
  bool operator ==(Object other) {
    return TerminalEndpointMapper.ensureInitialized()
        .equalsValue(this as TerminalEndpoint, other);
  }

  @override
  int get hashCode {
    return TerminalEndpointMapper.ensureInitialized()
        .hashValue(this as TerminalEndpoint);
  }
}
...
extension TerminalEndpointValueCopy<$R, $Out>
  ...
  TerminalEndpointCopyWith<$R, TerminalEndpoint, $Out>
      get $asTerminalEndpoint =>
          $base.as((v, t, t2) => _TerminalEndpointCopyWithImpl(v, t, t2));
}
...
class _TerminalEndpointCopyWithImpl<$R, $Out>
  ...
  TerminalEndpointCopyWith<$R2, TerminalEndpoint, $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
      _TerminalEndpointCopyWithImpl($value, $cast, t);
}
