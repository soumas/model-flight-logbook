...
@MappableEnum()
enum UtmSyncStatus {
  unknown(icon: Icons.hourglass_bottom, color: Colors.red, label: 'Status unbekannt - bitte warten'),
  ...
  error(icon: Icons.hourglass_bottom, color: Colors.red, label: 'Status unbekannt - bitte warten'),
