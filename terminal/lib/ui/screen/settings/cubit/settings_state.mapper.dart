...
class SettingsStateMapper extends ClassMapperBase<SettingsState> {
  ...
  static const Field<SettingsState, bool> _f$locked = Field(
    'locked',
    _$locked,
    opt: true,
    def: true,
  ...
  static const Field<SettingsState, bool> _f$loading = Field(
    'loading',
    _$loading,
    opt: true,
    def: false,
  ...
  static const Field<SettingsState, dynamic> _f$error = Field(
    'error',
    _$error,
    opt: true,
  );
