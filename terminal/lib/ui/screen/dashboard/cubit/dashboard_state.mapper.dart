...
class DashboardStateMapper extends ClassMapperBase<DashboardState> {
  ...
  static const Field<DashboardState, TerminalStatus> _f$terminalStatus = Field(
    'terminalStatus',
    _$terminalStatus,
    opt: true,
  );
...
class _DashboardStateCopyWithImpl<$R, $Out>
  ...
  ListCopyWith<
    ...
    TerminalEndpointCopyWith<$R, TerminalEndpoint, TerminalEndpoint>
  >
  get endpointOptions => ListCopyWith(
    $value.endpointOptions,
    (v, t) => v.copyWith.$chain(t),
    (v) => call(endpointOptions: v),
  );
  @override
  TerminalEndpointCopyWith<$R, TerminalEndpoint, TerminalEndpoint>?
  get selectedEndpoint => $value.selectedEndpoint?.copyWith.$chain(
    (v) => call(selectedEndpoint: v),
  );
  @override
  TerminalStatusCopyWith<$R, TerminalStatus, TerminalStatus>?
  get terminalStatus =>
  ...
  DashboardState $make(CopyWithData data) => DashboardState(
    ...
    selectedEndpoint: data.get(#selectedEndpoint, or: $value.selectedEndpoint),
