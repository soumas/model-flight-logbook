...
class FlightSessionListStateMapper
  ...
  static const Field<FlightSessionListState, bool> _f$loading =
  ...
  static const Field<FlightSessionListState, List<FlightSession>>
      _f$flightSessions =
      Field('flightSessions', _$flightSessions, opt: true, def: const []);
...
mixin FlightSessionListStateMappable {
  FlightSessionListStateCopyWith<FlightSessionListState, FlightSessionListState,
          FlightSessionListState>
      get copyWith => _FlightSessionListStateCopyWithImpl(
          this as FlightSessionListState, $identity, $identity);
  @override
  String toString() {
    return FlightSessionListStateMapper.ensureInitialized()
        .stringifyValue(this as FlightSessionListState);
  }

  @override
  bool operator ==(Object other) {
    return FlightSessionListStateMapper.ensureInitialized()
        .equalsValue(this as FlightSessionListState, other);
  }

  @override
  int get hashCode {
    return FlightSessionListStateMapper.ensureInitialized()
        .hashValue(this as FlightSessionListState);
  }
}
...
extension FlightSessionListStateValueCopy<$R, $Out>
  ...
  FlightSessionListStateCopyWith<$R, FlightSessionListState, $Out>
      get $asFlightSessionListState =>
          $base.as((v, t, t2) => _FlightSessionListStateCopyWithImpl(v, t, t2));
}
...
class _FlightSessionListStateCopyWithImpl<$R, $Out>
  ...
  ListCopyWith<$R, FlightSession,
          FlightSessionCopyWith<$R, FlightSession, FlightSession>>
      get flightSessions => ListCopyWith($value.flightSessions,
          (v, t) => v.copyWith.$chain(t), (v) => call(flightSessions: v));
  @override
  $R call({bool? loading, List<FlightSession>? flightSessions}) =>
  ...
  FlightSessionListStateCopyWith<$R2, FlightSessionListState, $Out2>
      $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
          _FlightSessionListStateCopyWithImpl($value, $cast, t);
}
